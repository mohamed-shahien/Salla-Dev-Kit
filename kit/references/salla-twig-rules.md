...
Salla-Dev-Kit preferred component start:
...
When creating new Salla-Dev-Kit components, use `{% set c = component %}`. When modifying existing Theme Raed components, prefer a minimal change that does not rewrite the full file unless requested.
