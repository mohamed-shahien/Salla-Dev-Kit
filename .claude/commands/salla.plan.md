...
8. Define JS strategy. Prefer conditional loading for new Salla Forge work; preserve Theme Raed `BasePage` pattern when modifying existing Raed behavior unless the spec says otherwise.
